...
function fetchTopStocks() {
    // Fetch data from api
    fetch('https://www.alphavantage.co/query?function=SECTOR&apikey=7JAAH6HXND4AB6N7').then(response => response.json()).then(data => {
...
function fetchStockData(symbol) {
    ...
    fetch(`https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=7JAAH6HXND4AB6N7`).then(response => response.json()).then(data => {
